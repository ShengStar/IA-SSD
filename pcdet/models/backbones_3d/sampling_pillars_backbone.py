...
class sampling_pillars_backbone(nn.Module):
    """ Backbone for IA-SSD"""
    ...
    def forward(self, batch_dict):
        ...
        points = batch_dict['points'] # [131072, 5]

        batch_idx, xyz, features = self.break_up_pc(points) # 返回点云特征
        ...
        for i in range(len(self.SA_modules)):
            xyz_input = encoder_xyz[self.layer_inputs[i]] # [8, 16384, 3]
            feature_input = encoder_features[self.layer_inputs[i]] # [8, 1, 16384]
